  ...
  return (
    <div className='flex flex-col w-full justify-center items-center'>
        <div className='relative flex flex-col justify-center items-center w-full py-10'>
          <h1 className='z-10 lg:text-[70px] md:text-[50px] sm:text-[40px] text-white'>Search for your new adventure here!</h1>
          <SearchBar/>
        ...
        <div className='flex flex-col justify-center items-center mt-10 w-[90%]'>
          <h2 className='lg:text-[70px] text-gray-500 mb-10 md:text-[60px] sm:text-[50px] w-[100%] text-left'>Quick Searches</h2>
        ...
        <div className='flex flex-col justify-center items-center mt-10 w-[90%]'>
          <h2 className='lg:text-[70px] text-gray-500 mb-5 md:text-[60px] sm:text-[50px] w-[100%] text-left'>Search for Nearby Spots</h2>
        </div>
    </div>
  )
}
